...
def setup_product():
    ...
    zcml.load_config('configure.zcml', Products.MeetingCommunes)
    ...
    ztc.installPackage('Products.MeetingCommunes')
...
setup_product()
ptc.setupPloneSite(products=['Products.MeetingCommunes'])
