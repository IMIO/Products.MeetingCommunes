...
collegeMeeting.dashboardItemsListingsFilters = ('c4', 'c6', 'c7', 'c8', 'c9', 'c10',
                                              'c11', 'c13', 'c14', 'c15', 'c16', 'c29', 'c32')
...
collegeMeeting.itemAdviceViewStates = ('proposed',
                                       ...
                                       'refused',
                                       'delayed')
collegeMeeting.usedAdviceTypes = ['positive', 'positive_with_comments', 'positive_with_remarks', 'cautious',
...
collegeTemplates = [dfAdviceTemplate, dashboardExportTemplate, dashboardDFTemplateOds,
...
agendaTemplatePDFCouncil.pod_template_to_use = {'cfg_id': councilMeeting.id, 'template_id': agendaTemplateCouncil.id}
...
decisionsTemplatePDFCouncil.pod_template_to_use = {'cfg_id': councilMeeting.id, 'template_id': decisionsTemplateCouncil.id}
...
itemTemplatePDFCouncil.pod_template_to_use = {'cfg_id': councilMeeting.id, 'template_id': itemTemplateCouncil.id}
...
dfAdviceTemplateCouncil.pod_template_to_use = {'cfg_id': collegeMeeting.id, 'template_id': dfAdviceTemplate.id}
...
dashboardDFTemplateOdsCouncil = PodTemplateDescriptor('synthese-avis-df-ods', 'Synthèse avis DF', dashboard=True)
dashboardDFTemplateOdsCouncil.pod_template_to_use = {'cfg_id': collegeMeeting.id,
                                                     'template_id': dashboardDFTemplateOds.id}
...
councilTemplates = [dfAdviceTemplateCouncil, dashboardExportTemplateCouncil,
...
councilMeeting.itemReferenceFormat = "python: 'CC/' + (here.hasMeeting() and " \
                                     "here.restrictedTraverse('@@pm_unrestricted_methods').getLinkedMeetingDate().strftime('%Y%m%d') or '') " \
                                     "+ '-' + str(here.getItemNumber(relativeTo='meeting', for_display=True))"
...
councilMeeting.itemAdviceViewStates = ('proposed',
                                       ...
                                       'refused',
                                       'delayed')
councilMeeting.usedAdviceTypes = ['positive', 'positive_with_comments', 'positive_with_remarks', 'cautious',
                                  'negative', 'negative_with_remarks', 'back_to_proposing_group', 'nil', 'read']
collegeMeeting.transitionsReinitializingDelays = ['backToItemCreated']
